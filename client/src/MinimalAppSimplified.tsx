...
const translations = {
  fr: {
    ...
    // Neue Übersetzungen für Zielgruppen-Sektion
    targetGroupsTitle: 'À qui s\'adresse ce guide ?',
    targetGroupsDescription: 'Le Luxembourg pas cher s\'adresse à une population souvent oubliée par la communication traditionnelle : des personnes qui vivent, travaillent ou étudient au Luxembourg et cherchent des solutions concrètes.',
    student: 'Étudiant·e',
    studentDescription: 'Qu\'ils soient luxembourgeois ou internationaux, les étudiant·es font face à un coût de la vie élevé, surtout pour le logement. Ils recherchent des ressources abordables et des repères pour mieux s\'intégrer.',
    entrepreneur: 'Auto-entrepreneur·e',
    entrepreneurDescription: 'Avec un budget restreint, il·elle jongle entre activité indépendante et charges personnelles. Le guide l\'aide à repérer des ressources abordables pour vivre dignement tout en poursuivant son projet.',
    families: 'Familles à budget restreint',
    familiesDescription: 'Familles monoparentales ou précaires, elles cumulent charge mentale et instabilité financière. Le guide leur apporte des ressources utiles pour alléger le quotidien et préserver un environnement digne pour leurs enfants.',
    newcomer: 'Nouvel arrivant',
    newcomerDescription: 'Nouvellement installé au Luxembourg, ce public a besoin de repères pour s\'orienter dans un environnement inconnu. Le guide propose des ressources claires, des démarches expliquées simplement et des clés pour s\'intégrer en douceur.',
    worker: 'Travailleurs à faible revenu',
    workerDescription: 'Travailleurs précaires ou en reconversion, ils ont besoin d\'outils concrets pour gérer leur budget, connaître leurs droits et trouver des services accessibles.',
    senior: 'Retraités en situation de précarité',
    seniorDescription: 'Confrontés à la baisse de leurs revenus, ils cherchent à maintenir une qualité de vie décente. Le guide les aide à identifier les aides spécifiques et les activités accessibles.',
    // Neue Übersetzungen für Testimonials
    testimonialsTitle: 'Témoignages des lecteurs',
    institutionalSupportTitle: 'Recommandé par les Communes et Offices Sociaux',
    institutionalSupportDescription: 'Utilisé et recommandé par les communes et offices sociaux, notre guide s\'est imposé comme un véritable atout dans l\'accompagnement des personnes en situation de précarité.',
    // Neue Übersetzungen für Werte-Sektion
    valuesTitle: 'Nos valeurs',
    valuesDescription: 'Nos valeurs guident chaque aspect de notre travail et nous permettent de créer un guide qui répond véritablement aux besoins de notre communauté.',
    transparency: 'Transparence',
    transparencyDescription: 'Nous prônons la transparence dans toutes nos actions. Nos lecteurs peuvent avoir confiance en l\'intégrité des informations et des recommandations que nous partageons.',
    socialResponsibility: 'Responsabilité Sociale',
    socialResponsibilityDescription: 'Nous favorisons l\'inclusion en mettant à disposition des solutions adaptées pour toutes les communautés, qu\'il s\'agisse des familles, des étudiants, des travailleurs précaires ou des aînés, afin de réduire les inégalités.',
    localEngagement: 'Engagement Local',
    localEngagementDescription: 'Nous valorisons et soutenons les entreprises locales, favorisant ainsi une économie circulaire et une société plus solidaire. Le guide promeut les initiatives locales qui contribuent à la vitalité et au bien-être de la communauté.',
    // Footer Übersetzungen
    faq: 'FAQ',
    ...
    subscribeToNewsletter: 'Recevez nos conseils, actualités et bons plans au Luxembourg directement dans votre boîte mail.',
    yourEmailAddress: 'Votre adresse email',
    subscribe: 'S\'abonner',
    copyright: '© 2023 Luxembourg Pas Cher',
  ...
  de: {
    ...
    // Neue Übersetzungen für Zielgruppen-Sektion
    targetGroupsTitle: 'An wen richtet sich dieser Leitfaden?',
    targetGroupsDescription: 'Das günstige Luxemburg richtet sich an eine Bevölkerungsgruppe, die in der traditionellen Kommunikation oft vergessen wird: Menschen, die in Luxemburg leben, arbeiten oder studieren und nach konkreten Lösungen suchen.',
    student: 'Student·in',
    studentDescription: 'Ob Luxemburger oder international, Studierende sind mit hohen Lebenshaltungskosten konfrontiert, besonders bei der Unterkunft. Sie suchen nach erschwinglichen Ressourcen und Orientierungshilfen für eine bessere Integration.',
    entrepreneur: 'Selbständige·r',
    entrepreneurDescription: 'Mit begrenztem Budget jongliert er/sie zwischen selbstständiger Tätigkeit und persönlichen Ausgaben. Der Leitfaden hilft, kostengünstige Ressourcen zu finden, um würdevoll zu leben und gleichzeitig das eigene Projekt voranzutreiben.',
    families: 'Familien mit begrenztem Budget',
    familiesDescription: 'Alleinerziehende oder prekäre Familien vereinen mentale Belastung und finanzielle Instabilität. Der Leitfaden bietet nützliche Ressourcen, um den Alltag zu erleichtern und eine würdige Umgebung für ihre Kinder zu erhalten.',
    newcomer: 'Neuankömmling',
    newcomerDescription: 'Als Neuling in Luxemburg braucht diese Zielgruppe Orientierung in einer unbekannten Umgebung. Der Leitfaden bietet klare Ressourcen, einfach erklärte Verfahren und Schlüssel für eine sanfte Integration.',
    worker: 'Geringverdiener',
    workerDescription: 'Prekäre Arbeitnehmer oder Menschen in beruflicher Neuorientierung benötigen konkrete Werkzeuge zur Verwaltung ihres Budgets, zur Kenntnis ihrer Rechte und zum Auffinden zugänglicher Dienstleistungen.',
    senior: 'Rentner in prekärer Lage',
    seniorDescription: 'Konfrontiert mit sinkendem Einkommen versuchen sie, eine angemessene Lebensqualität aufrechtzuerhalten. Der Leitfaden hilft ihnen, spezifische Unterstützung und zugängliche Aktivitäten zu identifizieren.',
    // Neue Übersetzungen für Testimonials
    testimonialsTitle: 'Was unsere Leser sagen',
    institutionalSupportTitle: 'Empfohlen von Gemeinden und Sozialämtern',
    institutionalSupportDescription: 'Unser Leitfaden wird von Gemeinden und Sozialämtern genutzt und empfohlen und hat sich als echte Unterstützung für Menschen in prekären Situationen erwiesen.',
    // Neue Übersetzungen für Werte-Sektion
    valuesTitle: 'Unsere Werte',
    valuesDescription: 'Unsere Werte leiten jeden Aspekt unserer Arbeit und ermöglichen es uns, einen Leitfaden zu erstellen, der wirklich auf die Bedürfnisse unserer Gemeinschaft eingeht.',
    transparency: 'Transparenz',
    transparencyDescription: 'Wir fördern Transparenz in all unseren Handlungen. Unsere Leser können der Integrität der Informationen und Empfehlungen, die wir teilen, vertrauen.',
    socialResponsibility: 'Soziale Verantwortung',
    socialResponsibilityDescription: 'Wir fördern Inklusion, indem wir angepasste Lösungen für alle Gemeinschaften bereitstellen, sei es für Familien, Studierende, prekäre Arbeitnehmer oder Senioren, um Ungleichheiten zu verringern.',
    localEngagement: 'Lokales Engagement',
    localEngagementDescription: 'Wir schätzen und unterstützen lokale Unternehmen und fördern so eine Kreislaufwirtschaft und eine solidarischere Gesellschaft. Der Leitfaden fördert lokale Initiativen, die zur Vitalität und zum Wohlbefinden der Gemeinschaft beitragen.',
    // Footer Übersetzungen
    faq: 'FAQ',
    contactUs: 'Kontakt',
    address: 'Adresse',
    ...
    email: 'E-Mail',
    newsletter: 'Newsletter',
    subscribeToNewsletter: 'Erhalten Sie unsere Tipps, Neuigkeiten und Angebote in Luxemburg direkt in Ihrem Posteingang.',
  ...
  en: {
    ...
    // New translations for target groups section
    targetGroupsTitle: 'Who is this guide for?',
    targetGroupsDescription: 'Luxembourg on a budget addresses a population often forgotten by traditional communication: people who live, work or study in Luxembourg and are looking for concrete solutions.',
    student: 'Student',
    studentDescription: 'Whether Luxembourgish or international, students face a high cost of living, especially for housing. They are looking for affordable resources and guidance to better integrate.',
    entrepreneur: 'Self-entrepreneur',
    entrepreneurDescription: 'With a limited budget, they juggle between independent activity and personal expenses. The guide helps them find affordable resources to live with dignity while pursuing their project.',
    families: 'Families on a tight budget',
    familiesDescription: 'Single-parent or precarious families combine mental burden and financial instability. The guide provides them with useful resources to lighten daily life and preserve a dignified environment for their children.',
    newcomer: 'Newcomer',
    newcomerDescription: 'Newly arrived in Luxembourg, this audience needs bearings to navigate an unfamiliar environment. The guide offers clear resources, simply explained procedures, and keys for smooth integration.',
    worker: 'Low-income workers',
    workerDescription: 'Precarious workers or those in professional reorientation need concrete tools to manage their budget, know their rights, and find accessible services.',
    senior: 'Seniors in precarious situations',
    seniorDescription: 'Faced with declining income, they seek to maintain a decent quality of life. The guide helps them identify specific aid and accessible activities.',
    // New translations for testimonials
    testimonialsTitle: 'What our readers say',
    institutionalSupportTitle: 'Recommended by Municipalities and Social Offices',
    institutionalSupportDescription: 'Used and recommended by municipalities and social offices, our guide has become a real asset in supporting people in precarious situations.',
    // New translations for values section
    valuesTitle: 'Our values',
    valuesDescription: 'Our values guide every aspect of our work and allow us to create a guide that truly addresses the needs of our community.',
    transparency: 'Transparency',
    transparencyDescription: 'We promote transparency in all our actions. Our readers can trust the integrity of the information and recommendations we share.',
    socialResponsibility: 'Social Responsibility',
    socialResponsibilityDescription: 'We promote inclusion by providing adapted solutions for all communities, whether families, students, precarious workers, or seniors, to reduce inequalities.',
    localEngagement: 'Local Engagement',
    localEngagementDescription: 'We value and support local businesses, thus promoting a circular economy and a more supportive society. The guide promotes local initiatives that contribute to the vitality and well-being of the community.',
    // Footer translations
    faq: 'FAQ',
    ...
    email: 'Email',
    newsletter: 'Newsletter',
    subscribeToNewsletter: 'Get our tips, news and deals in Luxembourg directly in your inbox.',
