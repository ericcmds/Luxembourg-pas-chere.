...
// Translations for the website in DE, FR, and EN
export const translations = {
  // German translations (default)
  de: {
    // Header
    search: "Suche nach Angeboten, Orten, Aktivitäten",
    searchButton: "Suchen",
  ...
  fr: {
    // Header
    search: "Rechercher des offres, lieux, activités",
  ...
  en: {
    // Header
    search: "Search for offers, places, activities",
    searchButton: "Search",
    ...
    offersDescription: "Discover our carefully curated offers for an unforgettable Luxembourg experience.",
    viewAllOffers: "View All Offers",
    
    // Contact Section
    contactTitle: "Contact Us",
    contactDescription: "Have questions or suggestions? Don't hesitate to reach out to us.",
    yourName: "Your Name",
    yourEmail: "Your Email",
    yourMessage: "Your Message",
    send: "Send",
    thankYou: "Thank you for your message! We'll get back to you shortly.",
